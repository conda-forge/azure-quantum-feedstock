...
Once the `conda-forge` channel has been enabled, `azure-quantum` can be installed with:

```
conda install azure-quantum
```

It is possible to list all of the versions of `azure-quantum` available on your platform with:
